...
public class UserRepositoryTest extends RepositoryTesting {
    ...
    public void testGetTableName() {
        ...
        assertEquals(EntityTypes.USER.toString(), instance.getTableName());
    }
    ...
    public void testUpdatePw() {
        ...
        if (entity1.isPresent()) {
            ...
            assertEquals(1, instance.updatePassword(entity1.get().getId(), newPw).getUpdates());
            String hashedPassword = instance.hashedPassword(1);
    ...
    public void testNewPw() {
        ...
        if (entity1.isPresent()) {
            final String newPw = Toolbox.getRandomString(9, true, true) + "?9Aa";
            assertEquals(1, instance.newPassword(entity1.get().getId(), newPw).getUpdates());
            String hashedPassword = instance.hashedPassword(1);
            assertTrue(BCrypt.checkpw(newPw, hashedPassword));
        } else {
            fail();
    ...
    public void testSave1() {
        ...
        user.setPw(null);
        assertEquals(0, instance.save(user).getUpdates());
        ...
        user.setUserEmail("login");
        user.setPw("ASDfGHjKL9!");
        assertEquals(1, instance.save(user).getUpdates());
    }
    ...
    public void testUpdateLastLogin() {
        ...
        if (entity1.isPresent()) {
            entity1.get().setLastLogin(dateTimeNow);
            assertEquals(1, instance.updateLastLogin(entity1.get().getId(), dateTimeNow).getUpdates());
        } else {
            fail();
        }
